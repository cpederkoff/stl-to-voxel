...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of padding pixels. Only used during .png output.",
    )
    parser.add_argument(
        "--no-parallel",
        dest="parallel",
    ...
    group.add_argument(
        "--resolution", type=int, default=100, help="Number of voxels in z direction"
    )
    group.add_argument(
        "--resolution-xyz",
        type=int,
    ...
    group.add_argument(
        ...
        type=float,
        dest="voxel_size",
        help="Size of voxel in all dimensions",
    )
    group.add_argument(
        "--voxel-size-xyz",
        type=float,
